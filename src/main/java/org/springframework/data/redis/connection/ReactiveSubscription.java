...
public interface ReactiveSubscription {
	 ...
	 * stream contains only messages for registered
	 * <p/>
	 ...
	 * all active {@link #receive() message streams}. Active streams will receive a
	 * {@link java.util.concurrent.CancellationException}.
	 * 
	 * @return a {@link Mono} that is notified once termination completes.
	 */
	Mono<Void> terminate();
