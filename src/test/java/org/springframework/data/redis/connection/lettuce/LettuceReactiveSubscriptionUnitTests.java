...
public class LettuceReactiveSubscriptionUnitTests {
	...
	@Test // DATAREDIS-612
	public void shouldNotUnsubscribeFromNotSubscribedChannel() {

		StepVerifier.create(subscription.unsubscribe(getByteBuffer("foo"), getByteBuffer("bar")))
				.expectErrorMessage("Attempting to unsubscribe without a subscription: [foo, bar]").verify();
	}
